...
public class QuestionsController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            this.loadColumns();
            this.tbQuestion.setItems(FXCollections.observableArrayList(questionServices.getQuestions()));
    ...
    private void loadColumns() {
        ...
        colContent.setCellFactory(new PropertyValueFactory("content"));
        colContent.setPrefWidth(200);
        
        TableColumn colHint = new TableColumn("Goi y");
        colHint.setCellFactory(new PropertyValueFactory("hint"));
        colHint.setPrefWidth(100);
        
        this.tbQuestion.getColumns().addAll(colId,colContent,colHint);
